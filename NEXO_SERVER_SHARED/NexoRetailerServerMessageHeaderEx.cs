...
namespace NEXO.Server
{
	...
	/// </summary>
	public class NexoRetailerServerMessageHeaderValidator//: INexoRetailerServerMessageHeaderValidator
	{
		#region constructors
		public NexoRetailerServerMessageHeaderValidator(MessageHeaderType mh, NexoProtocolVersion server)
		{
