...
namespace NEXO
{
	...
	public interface INexoReconciliation
	{
		#region owned
		[DispId(1)]
		ReconciliationRequestType RequestData { get; }
		[DispId(2)]
		ReconciliationResponseType ReplyData { get; }
		[DispId(3)]
	...
	public class NexoReconciliation: NexoService, INexoReconciliation
	{
		...
		public ReconciliationRequestType RequestData { get => (ReconciliationRequestType)RequestItem; }
		public ReconciliationResponseType ReplyData { get => (ReconciliationResponseType)ReplyItem; }
		#endregion
