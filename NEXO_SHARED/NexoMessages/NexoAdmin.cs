...
namespace NEXO
{
	...
	[ComVisible(true)]
	public interface INexoAdmin
	{
		#region owned
		[DispId(1)]
		AdminRequestType RequestData { get; }
		[DispId(2)]
		AdminResponseType ReplyData { get; }
		[DispId(3)]
		string RequestServiceIdentification { get; set; }
		#endregion
	...
	public class NexoAdmin: NexoService, INexoAdmin
	{
		...
		{
			RequestType = typeof(AdminRequestType);
			RequestItem = new AdminRequestType();
			ReplyType = typeof(AdminResponseType);
			ReplyItem = new AdminResponseType();
		}
		#endregion

		#region shared properties
		public AdminRequestType RequestData { get => (AdminRequestType)RequestItem; }
		public AdminResponseType ReplyData { get => (AdminResponseType)ReplyItem; }
		#endregion
