...
namespace NEXO
{
	...
	[ComVisible(true)]
	public interface INexoStoredValue
	{
		#region owned
		[DispId(1)]
		StoredValueRequestType RequestData { get; }
		[DispId(2)]
		StoredValueResponseType ReplyData { get; }
		[DispId(3)]
	...
	public class NexoStoredValue : NexoService, INexoStoredValue
	{
		...
		public StoredValueRequestType RequestData { get => (StoredValueRequestType)RequestItem; }
		public StoredValueResponseType ReplyData { get => (StoredValueResponseType)ReplyItem; }
		#endregion
