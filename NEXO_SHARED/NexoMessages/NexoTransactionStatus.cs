...
namespace NEXO
{
	...
	[ComVisible(true)]
	public interface INexoTransactionStatus
	{
		#region owned
		[DispId(1)]
		TransactionStatusRequestType RequestData { get; }
		[DispId(2)]
		TransactionStatusResponseType ReplyData { get; }
		[DispId(3)]
		MessageReferenceType RequestMessageReference { get; set; }
		[DispId(4)]
		bool RequestReceiptReprintFlag { get; set; }
		[DispId(5)]
		MessageReferenceType ReplyMessageReference { get; set; }
		#endregion
	...
	public class NexoTransactionStatus: NexoService, INexoTransactionStatus
	{
		...
		{
			RequestType = typeof(TransactionStatusRequestType);
			RequestItem = new TransactionStatusRequestType();
			ReplyType = typeof(TransactionStatusResponseType);
			ReplyItem = new TransactionStatusResponseType();
			RequestReceiptReprintFlag = false;
		}
		#endregion
