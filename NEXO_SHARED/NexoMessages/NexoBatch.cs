...
namespace NEXO
{
	...
	[ComVisible(true)]
	public interface INexoBatch
	{
		#region owned
		[DispId(1)]
		BatchRequestType RequestData { get; }
		[DispId(2)]
		BatchResponseType ReplyData { get; }
		#endregion
	...
	[Guid("EBBB6BA9-552F-40AC-92E2-7CB239988CF8")]
	[ClassInterface(ClassInterfaceType.None)]
	[ComVisible(true)]
	public class NexoBatch: NexoService, INexoBatch
	{
		#region constructor
		public NexoBatch() : base(MessageCategoryEnumeration.Batch)
		{
			RequestType = typeof(BatchRequestType);
			RequestItem = new BatchRequestType();
			ReplyType = typeof(BatchResponseType);
			ReplyItem = new BatchResponseType();
		}
		#endregion

		#region shared properties
		public BatchRequestType RequestData { get => (BatchRequestType)RequestItem; }
		public BatchResponseType ReplyData { get => (BatchResponseType)ReplyItem; }
		#endregion
