...
namespace NEXO
{
	...
	[ComVisible(true)]
	public interface INexoPIN
	{
		#region owned
		[DispId(1)]
		PINRequestType RequestData { get; }
		[DispId(2)]
		PINResponseType ReplyData { get; }
		[DispId(3)]
	...
	public class NexoPIN: NexoService, INexoPIN
	{
		...
		{
			RequestType = typeof(PINRequestType);
			RequestItem = new PINRequestType();
			ReplyType = typeof(PINResponseType);
			ReplyItem = new PINResponseType();
		}
		#endregion

		#region shared properties
		public PINRequestType RequestData { get => (PINRequestType)RequestItem; }
		public PINResponseType ReplyData { get => (PINResponseType)ReplyItem; }
		#endregion
