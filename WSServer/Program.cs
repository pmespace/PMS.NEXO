...
namespace WSServer
{
	internal class Program
	{
		...
		static void Main(string[] args)
		{
			...
			int index;
			string logFileName = WSServer.DEFAULT_LOG_FILE_NAME;
			string WSSettingsFileName = WSServer.DEFAULT_SETTINGS_FILE_NAME;
			...
			waits.Add(started);
			waits.Add(ended);
			WSServer.Start(WSSettingsFileName, started, ended);
		...
		static void TestListener(CListener listener)
		{
			...
			WSServer.SendRequest(fileToUse, evt);
			evt.WaitOne();
		}
	}
}