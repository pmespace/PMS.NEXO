...
namespace NEXO
{
	...
	[ComVisible(true)]
	public interface INexoGetTotals
	{
		#region owned
		[DispId(1)]
		GetTotalsRequestType RequestData { get; }
		[DispId(2)]
		GetTotalsResponseType ReplyData { get; }

		[DispId(50)]
		string ReplyPOIReconciliationID { get; set; }
		#endregion
	...
	public class NexoGetTotals: NexoService, INexoGetTotals
	{
		...
		{
			RequestType = typeof(GetTotalsRequestType);
			RequestItem = new GetTotalsRequestType();
			ReplyType = typeof(GetTotalsResponseType);
			ReplyItem = new GetTotalsResponseType();
		}
		#endregion

		#region shared properties
		public GetTotalsRequestType RequestData { get => (GetTotalsRequestType)RequestItem; }
		public GetTotalsResponseType ReplyData { get => (GetTotalsResponseType)ReplyItem; }
		#endregion
