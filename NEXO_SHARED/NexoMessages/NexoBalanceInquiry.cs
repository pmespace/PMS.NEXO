...
namespace NEXO
{
	...
	public interface INexoBalanceInquiry
	{
		#region owned
		[DispId(1)]
		BalanceInquiryRequestType RequestData { get; }
		[DispId(2)]
		BalanceInquiryResponseType ReplyData { get; }
		#endregion
	...
	[ComVisible(true)]
	public class NexoBalanceInquiry: NexoService, INexoBalanceInquiry
	{
		#region constructor
		public NexoBalanceInquiry() : base(MessageCategoryEnumeration.BalanceInquiry)
		{
			RequestType = typeof(BalanceInquiryRequestType);
			RequestItem = new BalanceInquiryRequestType();
			ReplyType = typeof(BalanceInquiryResponseType);
			ReplyItem = new BalanceInquiryResponseType();
		}
		#endregion

		#region shared properties
		public BalanceInquiryRequestType RequestData { get => (BalanceInquiryRequestType)RequestItem; }
		public BalanceInquiryResponseType ReplyData { get => (BalanceInquiryResponseType)ReplyItem; }
		#endregion
